...
function InPlay({ inPlay, price, userAccount }: Props) {
  ...
  return (
    <div className="mt-5">
      {inPlay.length === 0 && <>
        <p>There are currently no trades in-play. Make or Take an order to help keep the momentum going. Enjoy the blockchain!</p>
      </>} 
      {inPlay.length > 0 && userAccount && (
      <>
        <div className="mb-5">All in-play orders relating to your trading account</div>
