...
function Orderbook({ openOrders, price, userAccount, walletPubKey, connection, provider }: Props) {
  ...
  return (
    <div className="mt-5">    
      {openOrders.length === 0 && <>
        <p>
          There are currently no open orders showing. Feel free to create an order to help us keep going. It's all DevNet so
          there is no financial risk. Just make sure you DO NOT USE real SOL tokens!
        </p>
      </>}   
      {openOrders.length > 0 && userAccount && (
      <div className="">
        <div className="mb-5">All open orders across the entire program</div>
